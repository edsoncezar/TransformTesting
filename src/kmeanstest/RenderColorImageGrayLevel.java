 ...
 * 
 * This application renders a color image on a gray level image created from
 * scratch.
 * 
 * @author edson
 */
public class RenderColorImageGrayLevel {

	private static String pictureToTransform = "images/sweet.jpg";
	...
	public static void main(String[] args) throws IOException {
		...
		ImageIO.write(im, "PNG", new File("images/rendered_sweet_1.png"));

		DisplayJAI jai = new DisplayJAI(im);
